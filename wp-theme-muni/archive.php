...
/**
 * Plantilla para listados (Archivos, Categorías)
 *
    ...
    <div class="container">
        <?php if ( have_posts() ) : ?>
            <header class="page-header" style="margin-bottom: 3rem; text-align: center;">
                <?php
                the_archive_title( '<h1 class="page-title" style="font-size: 2.8rem; color: #1e293b; font-weight: 800; margin-bottom: 1rem;">', '</h1>' );
                the_archive_description( '<div class="archive-description" style="color: #64748b; font-size: 1.1rem;">', '</div>' );
                ?>
            </header>
        ...
        <?php else : ?>
            <div class="no-results" style="text-align: center; padding: 4rem 0;">
                <p style="font-size: 1.2rem; color: #64748b;"><?php esc_html_e( 'No se encontraron publicaciones.', 'muni-santa-juana' ); ?></p>
            </div>
        <?php endif; ?>
    </div>
</main>
